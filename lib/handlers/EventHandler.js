...
var EventHandler = function (handler, dir, client) { return __awaiter(void 0, void 0, void 0, function () {
    var path, files, _i, files_1, file, itemPath, stat, eventModule;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                return [4 /*yield*/, EventHandler(handler, dir, client)];
            case 4:
                _a.sent();
                return [3 /*break*/, 7];
            case 5:
                if (!file.endsWith(".js"))
                    return [2 /*return*/];
                return [4 /*yield*/, require(path_1.join(itemPath))];
            case 6:
                eventModule = _a.sent();
                eventModule(client);
                _a.label = 7;
