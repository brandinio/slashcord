...
var EventHandler = /** @class */ (function () {
    function EventHandler(client, handler, dir) {
        var _this = this;
        ...
        if (!fs_1.default.existsSync(newDir)) {
            throw new SlashError_1.default("The events directory: \"" + dir + "\" does not exist!");
        }
        var files = getFiles_1.default(newDir);
        var amount = files.length;
        if (amount === 0)
            return;
        console.log("Slashcord >> Loaded " + amount + " event" + (files.length === 1 ? "" : "s") + "!");
        (function () { return __awaiter(_this, void 0, void 0, function () {
            var _i, files_1, _a, file, fileName, event_1, _b;
                ...
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        if (typeof event_1 !== "function") {
                            throw new SlashError_1.default("The file: \"" + fileName + "\" is not a function!");
                        }
                        else
                            event_1(client);
                        _c.label = 4;
