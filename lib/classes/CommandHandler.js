...
var CommandHandler = /** @class */ (function () {
    function CommandHandler(handler, client, dir) {
        ...
        var _loop_1 = function (file, fileName) {
            ...
            if (!description) {
                throw new SlashError_1.default("A description is required for the command: \"" + name_1 + "\" since they are required in slash commands.");
            }
            if (testOnly && !handler.testServers) {
                throw new SlashError_1.default("\n          You specified \"" + name_1 + "\" with the \"testOnly\" feature, yet there aren't test servers!\n        ");
            }
            if (testOnly) {
