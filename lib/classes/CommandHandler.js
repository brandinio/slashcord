...
var CommandHandler = /** @class */ (function () {
    function CommandHandler(handler, client, dir, disabledCmds, testOnly) {
        var _this = this;
        var _loop_1 = function (file, fileName) {
            ...
            (function () { return __awaiter(_this, void 0, void 0, function () {
                var command, _a, _b, name, description, options, testOnly, category;
        ...
        for (var _i = 0, _a = getFiles_1.default(path_1.default.join(__dirname, "../commands")); _i < _a.length; _i++) {
        ...
        var _loop_2 = function (file, fileName) {
            (function () { return __awaiter(_this, void 0, void 0, function () {
                var command, _a, _b, name, description, options, testOnly, category, commands, commands, _loop_3, _i, _c, server;
                var _this = this;
        ...
        for (var _c = 0, files_1 = files; _c < files_1.length; _c++) {
            ...
            _loop_2(file, fileName);
        }
        //@ts-ignore
        client.ws.on("INTERACTION_CREATE", function (interaction) { return __awaiter(_this, void 0, void 0, function () {
            var _a, name, options, cmdName, command, cooldown, member, now, timeStamp, amount, timeLeft;
            return __generator(this, function (_b) {
                ...
                interaction = new Interaction_1.default(interaction, { client: client, member: member });
                ...
                if (timeStamp.has(interaction.member.user.id)) {
                    ...
                    if (now < timeLeft)
                        return [2 /*return*/, interaction.reply("Slow down! You still have `" + utils_1.msToTime(timeLeft - now) + "` before using that command again!")];
                }
