    ...
    function CommandHandler(handler, client, dir) {
        ...
        var _loop_1 = function (file, fileName) {
            (function () { return __awaiter(_this, void 0, void 0, function () {
                var command, _a, _b, name, description, options, testOnly, _loop_2, _i, _c, server;
                var _this = this;
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 2:
                            command = _a;
                            _b = command.name, name = _b === void 0 ? fileName : _b, description = command.description, options = command.options, testOnly = command.testOnly;
                            if (!description) {
