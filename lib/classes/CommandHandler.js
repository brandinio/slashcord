...
var CommandHandler = /** @class */ (function () {
    function CommandHandler(handler, client, dir) {
        ...
        if (!fs_1.default.existsSync(newDir)) {
            throw new SlashError_1.default("Slashcord >> The commands directory: \"" + dir + "\" does not exist!");
        }
        ...
        var _loop_1 = function (file, fileName) {
            ...
            if (!description) {
                throw new SlashError_1.default("Slashcord >> A description is required for the command: \"" + name_1 + "\" since they are required in slash commands.");
            }
