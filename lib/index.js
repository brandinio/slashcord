...
var SlashCommand_1 = __importDefault(require("./extras/SlashCommand"));
exports.Command = SlashCommand_1.default;
...
var Slashcord = /** @class */ (function () {
    function Slashcord(client, options) {
        var _this = this;
        ...
        this._categories = new discord_js_1.Collection();
        this._cooldowns = new discord_js_1.Collection();
        this._disabledCmds = [];
        this._testOnly = false;
        if (!client) {
            throw new SlashError_1.default("No Discord.JS client was passed in as the first parameter!");
        }
        this._client = client;
        ...
        if (options.defaultCommands) {
            var _a = options.defaultCommands, ping = _a.ping, help = _a.help, _b = _a.testOnly, testOnly = _b === void 0 ? false : _b;
            if (!ping) {
                var pingCmd = "PING";
        ...
        if (options.token) {
            client.login(options.token).catch(function () {
                throw new SlashError_1.default("You have provided a token, but it is invalid!");
            });
        }
        this._slashCmds = new SlashCommands_1.default(this, client);
        this._commandHandler = new CommandHandler_1.default(this, client, this._commandsDir, this._disabledCmds, this._testOnly);
    ...
    Object.defineProperty(Slashcord.prototype, "commands", {
        get: function () {
    ...
    Object.defineProperty(Slashcord.prototype, "cooldowns", {
        get: function () {
    ...
    Object.defineProperty(Slashcord.prototype, "categories", {
        get: function () {
