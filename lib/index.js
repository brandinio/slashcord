...
var Slashcord = /** @class */ (function () {
    function Slashcord(client, commandsDir, eventsDir) {
        var _this = this;
        this._commandsDir = "./commands";
        this._eventsDir = "";
        this._mongo = "";
        ...
        if (!client) {
            throw new Error("Slashcord >> No Discord client was passed in as the first argument!");
        }
        if (!commandsDir) {
            (function () { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            console.warn("Slashcord >> No commands directory was specified. Using \"./commands\"");
                            this._commandsDir = commandsDir || this._commandsDir;
                            return [4 /*yield*/, CommandHandler_1.CommandHandler(this, this._commandsDir, client, this.commands)];
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, slash_1.default(client, this.commands)];
                        case 2:
                            _a.sent();
                            return [2 /*return*/];
                    }
            ...
            (function () { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, CommandHandler_1.CommandHandler(this, commandsDir, client, this.commands)];
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, slash_1.default(client, this.commands)];
                        case 2:
        ...
        if (eventsDir) {
            (function () { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, EventHandler_1.EventHandler(this, eventsDir || this._eventsDir, client)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
    ...
    Slashcord.prototype.setMongoPath = function (mongoPath) {
