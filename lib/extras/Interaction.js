...
var Interaction = /** @class */ (function () {
    function Interaction(interaction, options) {
        ...
        this.channel = new discord_js_1.TextChannel(this.guild, { id: interaction.channel_id });
        this.client = options.client;
        this.member = new discord_js_1.GuildMember(this.client, { id: interaction.member.user.id }, this.guild);
        this.guild = new discord_js_1.Guild(this.client, { id: interaction.guild_id });
    }
