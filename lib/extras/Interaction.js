            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        //@ts-ignore
                        _a = this;
                        _c = (_b = this.guild.members.cache).get;
                        return [4 /*yield*/, member.user.id];
                    case 1:
                        //@ts-ignore
                        _a.member = _c.apply(_b, [_d.sent()]);
                        return [2 /*return*/];
                }
            });
        }); })();
    ...
    Interaction.prototype.delete = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [2 /*return*/, (this.client.api
                        //@ts-ignore
