...
var Interaction = /** @class */ (function () {
  function Interaction(interaction, options) {
    ...
    var member = function () {
      return new api_1.SlashDiscordAPI(_this.client)
  ...
  Interaction.prototype.followUp = function (content) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        new discord_js_1.WebhookClient(this.client.user.id, this.token).send(
          content
        );
        return [2 /*return*/];
      });
  ...
  Interaction.prototype.fetchReply = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.channel.messages.fetch(this.id)];
          case 1:
            msg = _a.sent();
            console.log(msg);
            return [2 /*return*/];
