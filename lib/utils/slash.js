...
exports.default = (function (client, commands) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        client.ws.on('INTERACTION_CREATE', function (interaction) { return __awaiter(void 0, void 0, void 0, function () {
            var _a, name, options, cmdName, command, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, command.execute({ client: client, interaction: interaction, args: options })];
                    case 2:
                        _b.sent();
                        return [3 /*break*/, 4];
                    case 3:
                        err_1 = _b.sent();
                        console.warn("Slashcord >> Error running the \"" + command.name + "\" command: " + err_1);
                        return [3 /*break*/, 4];
